    ...
    document.querySelector(".masters__slider") &&
      ...
      document.querySelector(".recomendations__slider") &&
        new de(".recomendations__slider", {
          ...
          speed: 800,
          pagination: {
            el: ".swiper-pagination .recomendations-pagination",
            clickable: !0,
          },
          navigation: {
      ...
      document.querySelector(".first-screen__slider") &&
        new de(".first-screen__slider", {
          modules: [pe, he],
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
          ...
          autoHeight: !0,
          speed: 800,
          pagination: { el: ".first-screen-pagination", clickable: !0 },
          navigation: {
            nextEl: ".first-screen-prev",
            prevEl: ".first-screen-next",
          },
          on: {},
        });
  });
  ...
  new me("max").init(),
    ...
    document.querySelector(".icon-menu") &&
      document.addEventListener("click", function (e) {
        ((n && e.target.closest(".icon-menu")) ||
          e.target.closest(".menu-overlay__link")) &&
          (((e = 500) => {
